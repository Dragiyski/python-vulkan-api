...
descriptor = {
    ...
    'output_of': set(),
    'member_map': {
        'sType': {'python_name': ['s', 'type'], 'value': 'VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHR', 'type': 'VkStructureType'},
        ...
        'pAcquireTimeouts': {'python_name': ['p', 'acquire', 'timeouts'], 'len': [['acquireCount']]},
