...
class VkSubpassDescriptionDepthStencilResolve(ctypes.Structure):
    ...
    _python_name_ = {
        'sType': 'type',
        'pNext': 'next',
        'depthResolveMode': 'depth_resolve_mode',
        'stencilResolveMode': 'stencil_resolve_mode',
    ...
    _vk_structure_type_ = 'VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE'
