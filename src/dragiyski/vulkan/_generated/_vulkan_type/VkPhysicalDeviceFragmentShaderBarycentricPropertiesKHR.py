...
class VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR(ctypes.Structure):
    ...
    _python_name_ = {
        'sType': 'type',
        'pNext': 'next',
        'triStripVertexOrderIndependentOfProvokingVertex': 'tri_strip_vertex_order_independent_of_provoking_vertex',
    }
    _vk_versions_ = set()
    _vk_extensions_ = {
    ...
    _vk_structure_type_ = 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_BARYCENTRIC_PROPERTIES_KHR'
