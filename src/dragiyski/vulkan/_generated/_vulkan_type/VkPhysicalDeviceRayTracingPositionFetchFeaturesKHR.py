...
class VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR(ctypes.Structure):
    ...
    _python_name_ = {
        'sType': 'type',
        'pNext': 'next',
        'rayTracingPositionFetch': 'ray_tracing_position_fetch',
    }
    _vk_versions_ = set()
    _vk_extensions_ = {
    ...
    _vk_structure_type_ = 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_POSITION_FETCH_FEATURES_KHR'
...
VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR._type_ = {
    'sType': ctypes.c_int,
    'pNext': ctypes.c_void_p,
    'rayTracingPositionFetch': ctypes.c_uint32,
}
