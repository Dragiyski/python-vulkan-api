...
class VkPhysicalDeviceProvokingVertexFeaturesEXT(ctypes.Structure):
    ...
    _python_name_ = {
        'sType': 'type',
        'pNext': 'next',
        'provokingVertexLast': 'provoking_vertex_last',
        'transformFeedbackPreservesProvokingVertex': 'transform_feedback_preserves_provoking_vertex',
    }
    _vk_versions_ = set()
    _vk_extensions_ = {
    ...
    _vk_structure_type_ = 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROVOKING_VERTEX_FEATURES_EXT'
