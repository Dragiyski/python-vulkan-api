...
class VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR(ctypes.Structure):
    ...
    _python_name_ = {
        'sType': 'type',
        'pNext': 'next',
        'shaderRelaxedExtendedInstruction': 'shader_relaxed_extended_instruction',
    }
    _vk_versions_ = set()
    _vk_extensions_ = {
    ...
    _vk_structure_type_ = 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_RELAXED_EXTENDED_INSTRUCTION_FEATURES_KHR'
