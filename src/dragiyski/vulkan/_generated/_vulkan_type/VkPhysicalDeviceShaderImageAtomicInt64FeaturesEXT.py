...
class VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT(ctypes.Structure):
    ...
    _python_name_ = {
        'sType': 'type',
        'pNext': 'next',
        'shaderImageInt64Atomics': 'shader_image_int64_atomics',
        'sparseImageInt64Atomics': 'sparse_image_int64_atomics',
    }
    _vk_versions_ = set()
    _vk_extensions_ = {
    ...
    _vk_structure_type_ = 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_IMAGE_ATOMIC_INT64_FEATURES_EXT'
