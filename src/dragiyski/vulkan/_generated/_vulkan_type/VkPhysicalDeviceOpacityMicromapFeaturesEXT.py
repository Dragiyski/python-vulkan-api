...
class VkPhysicalDeviceOpacityMicromapFeaturesEXT(ctypes.Structure):
    ...
    _python_name_ = {
        ...
        'pNext': 'next',
        'micromap': 'micromap',
        'micromapCaptureReplay': 'micromap_capture_replay',
        'micromapHostCommands': 'micromap_host_commands',
    }
    _vk_versions_ = set()
    _vk_extensions_ = {
    ...
    _vk_structure_type_ = 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_OPACITY_MICROMAP_FEATURES_EXT'
