...
class VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM(ctypes.Structure):
    ...
    _python_name_ = {
        'sType': 'type',
        'pNext': 'next',
        'multiviewPerViewRenderAreas': 'multiview_per_view_render_areas',
    }
    _vk_versions_ = set()
    _vk_extensions_ = {
    ...
    _vk_structure_type_ = 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PER_VIEW_RENDER_AREAS_FEATURES_QCOM'
