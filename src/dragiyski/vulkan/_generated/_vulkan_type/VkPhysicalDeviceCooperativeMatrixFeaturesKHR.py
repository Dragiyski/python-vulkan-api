...
class VkPhysicalDeviceCooperativeMatrixFeaturesKHR(ctypes.Structure):
    ...
    _python_name_ = {
        'sType': 'type',
        'pNext': 'next',
        'cooperativeMatrix': 'cooperative_matrix',
        'cooperativeMatrixRobustBufferAccess': 'cooperative_matrix_robust_buffer_access',
    }
    _vk_versions_ = set()
    _vk_extensions_ = {
    ...
    _vk_structure_type_ = 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_FEATURES_KHR'
