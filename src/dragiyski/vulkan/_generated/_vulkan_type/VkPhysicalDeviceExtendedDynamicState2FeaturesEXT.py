...
class VkPhysicalDeviceExtendedDynamicState2FeaturesEXT(ctypes.Structure):
    ...
    _python_name_ = {
        'sType': 'type',
        'pNext': 'next',
        'extendedDynamicState2': 'extended_dynamic_state2',
        'extendedDynamicState2LogicOp': 'extended_dynamic_state2_logic_op',
        'extendedDynamicState2PatchControlPoints': 'extended_dynamic_state2_patch_control_points',
    }
    _vk_versions_ = set()
    _vk_extensions_ = {
    ...
    _vk_structure_type_ = 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_2_FEATURES_EXT'
