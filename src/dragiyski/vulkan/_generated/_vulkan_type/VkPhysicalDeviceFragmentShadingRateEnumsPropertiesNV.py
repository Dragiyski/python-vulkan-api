...
class VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV(ctypes.Structure):
    ...
    _python_name_ = {
        'sType': 'type',
        'pNext': 'next',
        'maxFragmentShadingRateInvocationCount': 'max_fragment_shading_rate_invocation_count',
    }
    _vk_versions_ = set()
    _vk_extensions_ = {
    ...
    _vk_structure_type_ = 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_PROPERTIES_NV'
