...
class VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT(ctypes.Structure):
    ...
    _python_name_ = {
        'sType': 'type',
        'pNext': 'next',
        'attachmentFeedbackLoopLayout': 'attachment_feedback_loop_layout',
    }
    _vk_versions_ = set()
    _vk_extensions_ = {
    ...
    _vk_structure_type_ = 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ATTACHMENT_FEEDBACK_LOOP_LAYOUT_FEATURES_EXT'
