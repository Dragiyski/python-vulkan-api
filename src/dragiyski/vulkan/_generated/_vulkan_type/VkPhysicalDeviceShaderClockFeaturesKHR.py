...
class VkPhysicalDeviceShaderClockFeaturesKHR(ctypes.Structure):
    ...
    _python_name_ = {
        'sType': 'type',
        'pNext': 'next',
        'shaderSubgroupClock': 'shader_subgroup_clock',
        'shaderDeviceClock': 'shader_device_clock',
    }
    _vk_versions_ = set()
    _vk_extensions_ = {
        'VK_KHR_shader_clock',
    ...
    _vk_structure_type_ = 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CLOCK_FEATURES_KHR'
