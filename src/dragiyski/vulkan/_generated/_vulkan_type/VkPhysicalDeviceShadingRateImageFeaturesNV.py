...
class VkPhysicalDeviceShadingRateImageFeaturesNV(ctypes.Structure):
    ...
    _python_name_ = {
        'sType': 'type',
        'pNext': 'next',
        'shadingRateImage': 'shading_rate_image',
        'shadingRateCoarseSampleOrder': 'shading_rate_coarse_sample_order',
    }
    _vk_versions_ = set()
    _vk_extensions_ = {
    ...
    _vk_structure_type_ = 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADING_RATE_IMAGE_FEATURES_NV'
...
VkPhysicalDeviceShadingRateImageFeaturesNV._type_ = {
    'sType': ctypes.c_int,
    'pNext': ctypes.c_void_p,
    'shadingRateImage': ctypes.c_uint32,
    'shadingRateCoarseSampleOrder': ctypes.c_uint32,
