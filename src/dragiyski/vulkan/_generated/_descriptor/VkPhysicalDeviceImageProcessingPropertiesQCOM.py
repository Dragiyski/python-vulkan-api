...
_name_ = 'VkPhysicalDeviceImageProcessingPropertiesQCOM'
_member_list_ = ['sType', 'pNext', 'maxWeightFilterPhases', 'maxWeightFilterDimension', 'maxBlockMatchRegion', 'maxBoxFilterBlockSize']
_member_info_ = {
    'sType': {
        'type': CIntType('c_int'),
