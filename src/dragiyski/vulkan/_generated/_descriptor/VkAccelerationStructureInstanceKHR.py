...
_name_ = 'VkAccelerationStructureInstanceKHR'
_member_list_ = ['transform', 'instanceCustomIndex', 'mask', 'instanceShaderBindingTableRecordOffset', 'flags', 'accelerationStructureReference']
_member_info_ = {
    'transform': {
