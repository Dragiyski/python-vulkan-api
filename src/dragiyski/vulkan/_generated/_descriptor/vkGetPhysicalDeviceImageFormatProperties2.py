...
_error_code_list_ = {'VK_ERROR_OUT_OF_HOST_MEMORY', 'VK_ERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHR', 'VK_ERROR_IMAGE_USAGE_NOT_SUPPORTED_KHR', 'VK_ERROR_VIDEO_PICTURE_LAYOUT_NOT_SUPPORTED_KHR', 'VK_ERROR_VIDEO_PROFILE_OPERATION_NOT_SUPPORTED_KHR', 'VK_ERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR', 'VK_ERROR_FORMAT_NOT_SUPPORTED', 'VK_ERROR_OUT_OF_DEVICE_MEMORY'}
