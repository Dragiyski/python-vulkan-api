...
class VkAccessFlags(VulkanUIntFlag):
...
sys.modules[__name__] = VkAccessFlags

VkAccessFlags.VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_NV = VkAccessFlags.VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_KHR
VkAccessFlags.VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_NV = VkAccessFlags.VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_KHR
VkAccessFlags.VK_ACCESS_NONE_KHR = VkAccessFlags.VK_ACCESS_NONE
VkAccessFlags.VK_ACCESS_SHADING_RATE_IMAGE_READ_BIT_NV = VkAccessFlags.VK_ACCESS_FRAGMENT_SHADING_RATE_ATTACHMENT_READ_BIT_KHR
