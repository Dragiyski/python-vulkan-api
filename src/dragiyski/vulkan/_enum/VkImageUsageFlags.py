...
class VkImageUsageFlags(VulkanUIntFlag):
...
sys.modules[__name__] = VkImageUsageFlags

VkImageUsageFlags.VK_IMAGE_USAGE_SHADING_RATE_IMAGE_BIT_NV = VkImageUsageFlags.VK_IMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR
